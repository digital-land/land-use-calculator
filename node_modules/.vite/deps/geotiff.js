...
addDecoder([void 0, 1], () => import("./raw-FIQ5LTIM.js").then((m) => m.default));
addDecoder(5, () => import("./lzw-NI4DLQKL.js").then((m) => m.default));
addDecoder(6, () => {
  throw new Error("old style JPEG compression is not supported.");
});
addDecoder(7, () => import("./jpeg-D6IE75VD.js").then((m) => m.default));
addDecoder([8, 32946], () => import("./deflate-O7GY5SOZ.js").then((m) => m.default));
addDecoder(32773, () => import("./packbits-Y4X7BLVI.js").then((m) => m.default));
addDecoder(
  34887,
  () => import("./lerc-DLO6GZRP.js").then(async (m) => {
    await m.zstd.init();
    return m;
  }).then((m) => m.default)
);
addDecoder(50001, () => import("./webimage-4Y3M4LS7.js").then((m) => m.default));
  ...
  constructor(size = defaultPoolSize, createWorker) {
    ...
    if (size) {
      this._awaitingDecoder = createWorker ? Promise.resolve(createWorker) : new Promise((resolve) => {
        import("./decoder-XDADJHXA.js").then((module) => {
